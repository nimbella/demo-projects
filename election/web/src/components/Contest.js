...
function Contest() {
  return (
    <React.Fragment>
      <Helmet>
        <title>
          Contest - build, extend and end the year 2020 on a winning note.
        </title>
        <meta
          name="title"
      ...
      <div className="jumbotron">
        ...
        <p>
          Extend these election-related APIs/app and build your own election app
          to inspire your friends, family{" "}
          <span role="img" aria-label="family">
            👪
          </span>
          , and everyone you know to win{" "}
        ...
        <a
          href="https://nimbella.com/election2020"
